# Monster Hunter 4 (3DS) replacement server
...
```bash
$ git clone https://github.com/PretendoNetwork/monster-hunter-4
$ cd monster-hunter-4
```
...
$ go get -u
$ go mod tidy
$ go build -o build/monster-hunter-4
```

The server is now built to `build/monster-hunter-4`
...
The server is now built to `build/monster-hunter-4` with the authentication server build string already set
...
| `PN_MH4_ACCOUNT_GRPC_HOST`          | Host name for your account server gRPC service                                                                      | Yes                                           |
| `PN_MH4_ACCOUNT_GRPC_PORT`          | Port for your account server gRPC service                                                                           | Yes                                           |
| `PN_MH4_ACCOUNT_GRPC_API_KEY`       | API key for your account server gRPC service                                                                        | No (Assumed to be an open gRPC API)           |
| `PN_MH4_FRIENDS_GRPC_HOST`          | Host name for your friends server gRPC service                                                                      | Yes                                           |
